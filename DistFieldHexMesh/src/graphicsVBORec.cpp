...
void VBORec::changeFaceViewElements(bool visible, bool reference, const ChangeElementsOptions& opts)
{
...
void VBORec::changeEdgeViewElements(bool visible, bool reference, const ChangeElementsOptions& opts)
{
