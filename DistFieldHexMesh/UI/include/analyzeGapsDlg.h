...
namespace DFHM {
	...
	class AnalyzeGapsDlg : public wxDialog {
	public:

		AnalyzeGapsDlg(AppDataPtr& params, MainFrame* parent, wxWindowID id, const wxString& title,
	...
	private:
		...
		wxStaticText
			* _maxGapDistPrompt = nullptr,
			* _gridSizePrompt = nullptr;
