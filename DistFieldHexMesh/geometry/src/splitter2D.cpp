...
void Splitter2D::createPointPointMap(map<size_t, set<size_t>>& ptMap) const
{
...
size_t Splitter2D::createLoops(map<size_t, set<size_t>>& m, vector<Polyline>& polylines) const
{
	polylines.clear();
	PolylineNode n;
