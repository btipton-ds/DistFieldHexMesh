...
namespace DFHM {
	...
	public:
		...
		static bool connectIntersectEdges(const Block* pBlock, const MTC::set<IntersectEdge>& edges, MTC::vector<MTC::vector<Index3DId>>& faceVertices, bool isIntersection = false);
