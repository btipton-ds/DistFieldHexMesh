...
enum ModelMeshDrawType {
	MMDT_MODEL_SOLID,
	MMDT_MODEL_SURFACE,
	MMDT_MODEL_SOLID_GAP,
	MMDT_MODEL_SURFACE_GAP,
	MMDT_MODEL_ALL
};

enum HexMeshDrawType {
	HMDT_MESH_ERROR_WALL,
	HMDT_MESH_INNER,
...
enum DrawStates {
	...
	DS_MODEL_FACES_SOLID_GAP,
	DS_MODEL_FACES_SURFACE,
	DS_MODEL_FACES_SURFACE_GAP,
	DS_MODEL_EDGES,
