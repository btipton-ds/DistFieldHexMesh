...
#define ENABLE_FILE_PACKET_SIZE_CHECKS 1
#define ENABLE_VERTEX_DEBUG_GRAPHICS 1
#define ENABLE_GAP_DEBUG_GRAPHICS 1

#if DEBUGGING_MUTEXES_AVAIL
#define ENABLE_DEBUGGING_MUTEXES (0 && (RUN_MULTI_THREAD || RUN_MULTI_SUB_THREAD))
#else
